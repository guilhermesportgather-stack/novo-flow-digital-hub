...
<section id="sobre" className="py-24">
    <div className="section-container">
      ...
      className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-6 text-lg leading-relaxed text-muted-foreground">A Novo Flow nasceu com o propósito de ajudar empresas a entrarem em uma nova fase no digital. Oferecemos estratégias personalizadas, combinando tecnologia avançada com atendimento humano, para que cada cliente alcance resultados reais e previsíveis.
